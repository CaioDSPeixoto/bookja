...
export async function buscarHistoriaPublica(id: string) {
  ...
  const documentosPublicos = (data.documento as Array<{ id: string; titulo: string; tipo: string; publico: boolean; status?: string; ordem: number; publicado_em: string | null }>)
